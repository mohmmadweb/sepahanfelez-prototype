...
-- پس از اجرا
-- =====================================================================
-- • کارشناسان و نرخ‌ها را از پنل وارد کنید، سپس کلیدهای `experts` و
--   `freight` را از config/redesign.php حذف کنید. کد خودش جدول را ترجیح
--   می‌دهد و هیچ تغییر دیگری لازم نیست.
--
